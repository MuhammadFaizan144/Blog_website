      ...
      <section className="min-h-screen flex items-center justify-center bg-gray-100 py-10">
        ...
        <div className="w-[448px] h-[728px] bg-white rounded-[10px] 
          ...
          <div className="flex justify-center items-center ">
            <img src="/images/logo.png" alt="" className='size-[48px] bg-[#067FF9FF] rounded-lg m-1 '/>
          </div>
          

          <h1 className="text-2xl font-bold font-merriweather text-center mt-4 mb-2">
            Welcome Back
          </h1>
          ...
          <p className='text-blue-600 text-[12px] mt-6'>Forgot password?</p>
          {/* Button */}
          <button className="mt-3 bg-blue-600 text-white py-3 rounded-lg">
            Login →
          </button>
          ...
          <div className="flex justify-center mt-6">
            <p className='font-sans text-[11px] text-gray-500 px-7 text-center'>By clicking continue, you agree to our <span className='underline'>Terms of Service</span> and <span className='underline'>Privacy Policy.</span></p>
