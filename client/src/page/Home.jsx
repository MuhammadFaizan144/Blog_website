...
const Home = () => {
  ...
  {/* hero */}
  <section className="grid grid-cols-2 max-lg:grid-cols-1 max-w-[1440px] w-full min-h-screen gap-10">
    ...
    <div className="flex justify-center items-center ">
      ...
      <div className="relative w-full max-w-[560px] rounded-3xl shadow-[0px_25px_50px_#067FF91A] p-2 bg-white">
        ...
        />
        <div className="w-[200px] max-sm:w-[160px] absolute font-sans border border-[#DEE1E6FF] bg-white rounded-lg left-[-40px] bottom-[-40px] flex flex-col items-center p-5 gap-2 shadow-[0px_0px_2px_#171a1f14,0px_8.5px_13.75px_#171a1f38]">
